...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 25, 2023 lúc 08:52 AM
...
(31, 'Trà OLong', 30, 'g', 55000),
(32, 'Nam việt quốc', 700, 'g', 236000),
...
--
ALTER TABLE `ingredient_defaut`
  MODIFY `id_id` int(100) NOT NULL AUTO_INCREMENT COMMENT 'Gốc Id', AUTO_INCREMENT=36;
