...
<body>
    ...
    <section class="container-fluid d-flex align-items-center"
        ...
        <section class="container-fluid" style="background-color:#dac991;">
            <div class="contaner mx-5 py-5">
                <div class="row mx-5 px-5">
                    <div class="col-5 my-5">
                        <h6 class="mb-0 mt-2" style="font-family: Pacifico; color:#542D21">About us</h6>
                        <h2 class="mb-0 mt-2" style="color:#542D21; font-family: Quicksand;">We found our creative space that is open for you.</h2>
                    </div>
                    <div class="col-7 my-5">
                        <span>Lorem ipsum viverra feugiat. Pellen tesque libero ut justo, ultrices in ligula. Semper at tempufddfel. Lorem ipsum dolor sit amet elit. Non quae, fugiat nihil ad. Lorem ipsum dolor sit amet. Lorem ipsum init dolor sit, amet elit. Dolor ipsum non velit, culpa!Lorem ipsum init dolor sit.<br>

                            Lorem ipsum viverra feugiat. Pellen tesque libero ut justo, ultrices in ligula. Semper at tempufddfel. Lorem ipsum dolor sit amet elit. Non quae, fugiat nihil ad. Lorem ipsum dolor sit amet.</span>
                    </div>
                </div>
            </div>
        </section>
        <section class="container-fluid"
            style="background-color:#542D21;">
            <div class="row">
                <div class="col-6 img-fluid" id="intro">
                    <style>
                        #intro{
                ...
                <div class="col-6">
                    <div class="container px-5 pt-5">
                        <div class="fs-6 my-2"
                            ...
                            30 drinks</div>
                        <div class="fs-3 my-2"
                            style="font-family: Quicksand; color:#dac991 ">Book
                        ...
                        <div class="row my-5">
                            <div class="col-6">
                                ...
                                <a href="#"
                                    class="subscribe-cat-link text-decoration-none"
                                    style="color: #dac991;">Best
                                    Deals</a>
                            ...
                            <div class="col-6">
                                <div class=" mb-4">
                                    <span class="fa fa-cutlery p-4 rounded-2 border-3 icon" style="border-color: #dac991;"></span>
                                </div>
                                <a href="#"
                                    class="subscribe-cat-link text-decoration-none"
                                    style="color: #dac991;">Best
